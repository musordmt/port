<script lang="ts">
	...
	import SkillLogo from '../Card/SkillLogo.svelte';
...
<Card color={project.color} href={`${base}/projects/${project.slug}`}>
	<SkillLogo alt={project.name} src={getAssetURL(project.logo)} size={40} radius={'0'} />
	...
	<div class="col sm:h-100px md:h-80px">
		<p
			class="text-[0.95em] text-[var(--secondary-text)] font-300 m-t-20px m-b-20px flex-1 line-clamp-3"
		>
